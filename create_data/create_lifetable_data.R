...
equilbrium_age <- equilibrium_age_distribution(smooth_life_table)
# View outputs
par(mfrow = c(1, 2))
plot(age_of_death, ylab = "Probability", main = "Age of death", pch = 19)
plot(equilbrium_age, ylab = "Probability", main = "Age distribution", pch = 19)
#Save data for use in package
devtools::use_data(age_of_death)
devtools::use_data(equilbrium_age)
